...
namespace LibraryManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        // GET: /Account/Login
        [AllowAnonymous]
        public ActionResult Login(string returnUrl,string User=null)
        {
            if(User!=null)
            {
                ViewBag.User = User;
        ...
        private ActionResult RedirectToLocal(string returnUrl,string Role)
        {
            ...
            else
            {
                ...
                {
                    return RedirectToAction("Index", "School", new { area = "School" });
                }
                else if (Role == "Library")
                {
                    return RedirectToAction("Index", "Library", new { area = "Library" });
                }
                 else
                {
